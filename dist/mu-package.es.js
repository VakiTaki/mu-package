...
function je() {
  ...
  return w.Fragment = _, w.jsx = p, w.jsxs = p, w;
}
var j = {};
/**
 * @license React
...
` + l[a].replace(
    ...
    function G(e, r, t, n, u, a) {
      if (typeof e == "string" || typeof e == "function" || e === P || e === F || e === X || e === M || e === $ || e === Te || typeof e == "object" && e !== null && (e.$$typeof === U || e.$$typeof === W || e.$$typeof === Z || e.$$typeof === L || e.$$typeof === Y || e.$$typeof === Re || e.getModuleId !== void 0)) {
        var o = r.children;
        if (o !== void 0)
          if (n)
            if (q(o)) {
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
      ...
      if (o = null, t !== void 0 && (p(t), o = "" + t), ve(r) && (p(r.key), o = "" + r.key), "key" in r) {
        t = {};
        for (var T in r)
          T !== "key" && (t[T] = r[T]);
      } else t = r;
...
var ke = he();
const Oe = ({ label: s, onClick: _ }) => /* @__PURE__ */ ke.jsx(
  "button",
  {
    onClick: _,
    style: {
