...
function he() {
  ...
  return p.Fragment = _, p.jsx = y, p.jsxs = y, p;
}
var h = {};
/**
 * @license React
...
` + l[a].replace(
    ...
    function G(e, r, t, n, u, a) {
      if (typeof e == "string" || typeof e == "function" || e === P || e === F || e === X || e === M || e === $ || e === xe || typeof e == "object" && e !== null && (e.$$typeof === U || e.$$typeof === W || e.$$typeof === Z || e.$$typeof === L || e.$$typeof === Y || e.$$typeof === Re || e.getModuleId !== void 0)) {
        var o = r.children;
        if (o !== void 0)
          if (n)
            if (q(o)) {
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
      ...
      if (o = null, t !== void 0 && (y(t), o = "" + t), ve(r) && (y(r.key), o = "" + r.key), "key" in r) {
        t = {};
        for (var x in r)
          x !== "key" && (t[x] = r[x]);
      } else t = r;
...
var Ee;
function Ce() {
  return Ee || (Ee = 1, process.env.NODE_ENV === "production" ? k.exports = he() : k.exports = je()), k.exports;
}
var ke = Ce();
const Se = ({ label: s, onClick: _ }) => /* @__PURE__ */ ke.jsx(
  "button",
  {
    onClick: _,
